...
//        SerialPort port = BaseUSBListener.openComPort("", 9600, SerialPort.DATABITS_8, SerialPort.STOPBITS_1, SerialPort.PARITY_NONE);
//        byte[] order = new byte[1];
//        order[0] = '?';
//        BaseUSBListener.sendDataToComPort(port, order);
//        try {
